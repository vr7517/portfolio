...
useEffect(() => {
  ...
  return (
    ...
    >
      {/* Side Email */}
      <div className="absolute top-1/2 -left-24 hidden sm:flex rotate-90 bg-[#EFEFE6] text-black p-12">
      ...
      {/* Content */}
      <div className="relative z-10 h-full max-w-4xl mx-auto flex flex-col lg:flex-row justify-center items-center gap-10 lg:gap-16 p-6 md:p-8 border border-gray-300 dark:border-neutral-800">
        {/* Social Icons */}
        <div
          ref={iconsRef}
        ...
        <div className="relative w-full max-w-3xl text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mt-6">
            <button
              ref={contactBtnRef}
              className="px-6 py-3 border border-black bg-orange-600 text-white rounded-md hover:bg-white hover:text-black transition duration-300"
            >
              GET IN TOUCH
            </button>
            ...
            <button
              ...
              className="px-6 py-3 border border-orange-600 text-orange-600 rounded-md hover:bg-orange-600 hover:text-white transition duration-300"
            >
              VIEW RESUME
            </button>
          </div>
